...
from pyramid_admin.form import BaseForm, FormOpts, rules
from pyramid_admin.model import filters, typefmt
from pyramid_admin.actions import ActionsMixin
...
class BaseModelView(BaseView, ActionsMixin):
    ...
    """
        ...
        or using Jinja2 `macro` in template::
            ...
            from pyramid_admin.model.template import macro
    ...
    """
        ...
        something like this::
            ...
            from pyramid_admin.model import typefmt
    ...
    """
        ...
        Can contain either field names or instances of :class:`~pyramid_admin.model.filters.BaseFilter` classes.
    ...
    def get_list_form(self):
        """
            ...
            Allows overriding the editable list view field/widget. For example::
                ...
                from pyramid_admin.model.widgets import XEditableWidget
